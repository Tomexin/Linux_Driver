...
{
	major = register_chrdev(0, "third_drv", &third_drv_fops);//注册驱动程序

	third_drv_class = class_create(THIS_MODULE, "third_drv");

	third_drv_class_dev = class_device_create(third_drv_class, NULL, MKDEV(major, 0), NULL, "third_drv");//创建设备节点/dev/firstdrv
